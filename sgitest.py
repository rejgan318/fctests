...
left_col = [
    [sg.Text('Folder'), sg.In(size=(25, 1), enable_events=True, default_text='testpict', key='-FOLDER-'), sg.FolderBrowse()],
...
images_col = [[sg.Text(size=(40, 1), key='-TOUT-')],
              [sg.Image(key='-IMAGE-')]]
# ----- Full layout -----
layout = [[sg.Column(left_col, element_justification='c', vertical_alignment='top'),
           # sg.VSeperator(),
           sg.Column(images_col, element_justification='c')]]
# --------------------------------- Create Window ---------------------------------
window = sg.Window('Multiple Format Image Viewer', layout, resizable=True, return_keyboard_events=True)
new_size = None
# Right:39 Left:37 Up:38 Down:40 Alt_L:18 Control_L:17 Control_R:17
while True:
